...
<?
    ...
    $bgarea = ($cancelled?'greenarea':'redarea');
...
?>
    ...
    <div class="item" id="item<?= $l['leadid']?>">
        <div class="bodyarea left">
            <div class="row">
                <div class="title"><a href="<?= $link; ?>"><?= $l['title']?></a></div>
                <div class="clear"></div>
            </div>
            <div class="row">
                <div class="<?= $bgarea; ?> left"><?= round($l['amount'], 1)?> млн руб</div>
                <div class="orgarea graybg"><a href="/orgs/<?= $l['orgid']; ?>"><?= $l['org_name']; ?></a></div>
                <div class="clear"></div>
            </div>
            ...
            <div class="adminarea">
                ...
                <div class="tiny orange right" style="padding-right:10px;"><a href="/admin/publish/<?= $leadid; ?>">Редактировать</a></div>
            </div>
            <? } ?>
        </div>
